...
The app expects a FastAPI backend serving JSON under `/api/v1` with run discovery, run detail, case workspace/detail, agent workspace, analysis dashboard, case drill-down, and comparison endpoints.
