      ...
      <section className="panel">
        <div className="panel-header">
          <div>
            ...
            <p className="panel-copy">
              The eval pipeline keeps conventional ML/DL baselines, LLM systems, and AI agents on one reproducible instance index.
            </p>
          </div>
          {run.eval.report_summary_path ? (
            <Link to="/runs/$runName/eval" params={{ runName }} className="button-link">
        ...
        {run.eval.report_summary_path == null ? (
          <EmptyState
            ...
            description="Run `oneehr eval build`, `oneehr eval run`, and `oneehr eval report` to compare ML/DL baselines, LLM systems, and AI agents."
          />
        ) : (
          <div className="detail-grid">
            <div>
