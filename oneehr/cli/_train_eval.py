...
def maybe_calibrate_and_threshold(
    *,
    ...
    if y_val_logits is not None:
        y_val_cal, params = calibrate_from_logits(y_val_true, y_val_logits, method="temperature")
    else:
        y_val_cal, params = calibrate_from_probs(y_val_true, y_val_score, method="temperature")
