...
_SPECS: dict[str, _ModelSpec] = {
    ...
    "concare": _ModelSpec("oneehr.models.concare", "ConCareModel", "ConCareTimeModel", "concare", _concare_kwargs, uses_static=True),
    "grasp": _ModelSpec("oneehr.models.grasp", "GRASPModel", "GRASPTimeModel", "grasp", _grasp_kwargs, uses_static=True),
