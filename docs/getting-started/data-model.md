...
4. Tabular views for `patient` or `time` prediction are materialized for modeling
5. All downstream commands read from the materialized run artifacts instead of reinterpreting raw files
