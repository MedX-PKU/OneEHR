...
def test_knn_impute():
    ...
    fitted = fit_pipeline(df, pipeline)
    out = transform_pipeline(df, fitted)
...
def test_fit_on_train_transform_test():
    ...
    fitted = fit_pipeline(train, pipeline)
    train_t = transform_pipeline(train, fitted)
    test_t = transform_pipeline(test, fitted)
